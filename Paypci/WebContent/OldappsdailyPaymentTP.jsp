...
<body>
	<form method="post" id="customerData" name="customerData"
		autocomplete="off" action="pay">
		<input type="hidden" name="elementNo" id="elementNo" value="1" /> <input
			type="hidden" name="action" id="action" value="paymentgatewayjsontp" />
		<!-- 		<input type="hidden" name="elementNo" id="elementNo" value="1" /> <input -->
		<!-- 			type="hidden" name="action" id="action" value="paymentgatewayjsoncc" /> -->
			...
			<div class="col-sm-12 pad0 main-wrapper">
				...
				<div class="parent-div tabbable tabs-left card-content-wrapper">
					...
					<ul id="menu-tabs-ul"
						...
						data-tabs="tabs">
						<li class="active"><a href="#CreditCard"
							class="menu-about-link payOption" data-toggle="tab"
							id="idforfirsttimeclickeventtab1" data-value1="OPTCRDC"
							data-value2="1"><img src="images/nav/cards.png"
								class="payment-type-icon">CreditCard</a></li>
						<li class=""><a href="#DebitCard"
							class="menu-about-link payOption" data-toggle="tab"
							data-value1="OPTDBCRD" data-value2="2"
							id="idforfirsttimeclickeventtab2"><img
								src="images/nav/cards.png" class="payment-type-icon">DebitCard</a></li>
						<li class=""><a href="#NetBanking"
							class="menu-about-link payOption" data-toggle="tab"
							data-value1="OPTNBK" data-value2="4"
					...
					<div class="tab-content  col-sm-12 col-xs-12">
						...
						<div class="tab-pane fade  active in" id="CreditCard">
							<div class="clearfix"></div>
							<div class="row">
						...
						<div class="tab-pane fade" id="DebitCard">
							<div class="clearfix"></div>
							<div class="row">
								<div class="col-md-12 card-box">
									<div class="row form-group hidden">
	...
	$(document).ready(function() {
		...
		$(function(){
			 ...
			 var jsonData;
			  ...
			  $
						.ajax({
							url : 'pay?action=getdatajsontp&amount=' + amount,
							dataType : 'jsonp',
							jsonp : false,
...
// 				 analytics(url,'{"analytics":[{"timestamp":"'+n+'","order_id":"'+order_id+'","card_type":"'+creditCardNameText+'","bank_name":"credit_card","action_id":"1352"}],"subinfo":{},"validation_info":{}}');
			}
		}
...
<%-- 				 var url='<%=PaymentProperties.getAnalyticsUrl(  )%>'; --%>
<%-- 				 var order_id='<%=(String) request.getAttribute("order_id")%>'; --%>
// 				 analytics(url,'{"analytics":[{"timestamp":"'+n+'","order_id":"'+order_id+'","card_type":"'+card_nameText+'","bank_name":"debit_card","action_id":"1353"}],"subinfo":{},"validation_info":{}}');
...
<%-- 			 var order_id='<%=(String) request.getAttribute("order_id")%>'; --%>
			 $('<input />').attr('type', 'hidden')
	          ...
	          .appendTo('#customerData');
			 $("#customerData").submit();
// 			 analytics(url,'{"analytics":[{"timestamp":"'+n+'","order_id":"'+order_id+'","bank_name":"'+issuing_bankText+'","action_id":"1351"}],"subinfo":{},"validation_info":{}}');
		}else{
			$('.card-err-msg').remove();
